...
urlpatterns = [
    path(
        "pages/profile/user/",
        PagesView.as_view(template_name="pages_profile_user.html"),
        name="pages-profile-user",
    ),
    path(
        "pages/profile/teams/",
        PagesView.as_view(template_name="pages_profile_teams.html"),
        name="pages-profile-teams",
    ),
    path(
        "pages/profile/projects/",
        PagesView.as_view(template_name="pages_profile_projects.html"),
        name="pages-profile-projects",
    ),
    path(
        "pages/profile/connections/",
        PagesView.as_view(template_name="pages_profile_connections.html"),
    ...
    path(
        ...
        PagesView.as_view(template_name="pages_account_settings_security.html"),
        name="pages-account-settings-security",
    ),
    path(
        "pages/account_settings/billing/",
        PagesView.as_view(template_name="pages_account_settings_billing.html"),
    ...
    path(
        "pages/faq/",
        PagesView.as_view(template_name="pages_faq.html"),
        name="pages-faq",
    ),
    path(
        "pages/pricing/",
        PagesView.as_view(template_name="pages_pricing.html"),
        name="pages-pricing",
    ),
    path(
        "pages/misc/error/",
